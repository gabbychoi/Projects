CREATE VIEW SCM.VW_SCM_ZROUTING
AS
SELECT 
MARC.DISPO,
...
JOIN ODS_YG1.ods_scm.TB_ODS_ZROUTING_MAPL AS MAPL 
ON MARC.MATNR = MAPL.MATNR
AND MARC.WERKS = MAPL.WERKS
JOIN ODS_YG1.ods_scm.TB_ODS_ZROUTING_PLKO AS PLKO 
...
JOIN ODS_YG1.ods_scm.TB_ODS_ZROUTING_PLAS AS PLAS
ON PLKO.PLNTY = PLAS.PLNTY
AND PLKO.PLNNR = PLAS.PLNNR
AND PLKO.PLNAL = PLAS.PLNAL
JOIN ODS_YG1.ods_scm.TB_ODS_ZROUTING_PLPO AS PLPO 
...
JOIN ODS_YG1.ods_scm.TB_ODS_ZROUTING_CRHD AS CRHD 
ON PLPO.ARBID = CRHD.[OBJID]
AND PLPO.WERKS = CRHD.WERKS
JOIN DW_YG1.dbo.TB_DW_DIM_MARA AS MARA 
ON MARA.MATNR = MARC.MATNR
JOIN ODS_YG1.ods_scm.TB_ODS_ZROUTING_ZPPT075 AS ZPPT075
